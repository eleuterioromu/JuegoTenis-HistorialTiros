...
class Tenis{
    ...
    static String puntos_nombre_en[] = {"love","fifteen", "thirteen", "fourteen", "Avantage","win","deuce"};
    static String puntos_nombre_es[] = {"amor","Quince", "Treinta", "Cuarenta", "Ventaja","gana","empate"};
    static String puntos_nombre_fr[] = {"amore","Quinze", "Trente", "Quarante", "Avantage","Fransua","empatefr"};
    static String puntos_nombre_al[] = {"Liebe","Funfzehn", "DreiBig", "Vierzig", "Spieler bewegt","Spieler gewint","ziehen"};
    int count=1;
    public Tenis(){}
    ...
    public void score(String idiomas[]){
        ...
        if(player.ganador() != 1 && player.getTirosJugador_a() < 4){
            ...
            System.out.println(mi_idioma[player.getTirosJugador_a()]+ mi_idioma[player.getTirosJugador_b()]);
  
            
        }
        if(player.ganador() != 2 && player.getTirosJugador_b() < 4){
         //   System.out.println(mi_idioma[player.getTirosJugador_b()] + mi_idioma[player.getTirosJugador_b()]);
        }
